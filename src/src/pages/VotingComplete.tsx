    ...
    <div className="kiosk-fullscreen flex flex-col items-center justify-center bg-background px-6">
      ...
      >
        ...
        <div className="space-y-4">
          <h1 style={fontFamily} className="text-3xl mb-10 text-green-500 md:text-4xl font-display font-bold text-foreground">
            ¡Voto emitido exitosamente!
          </h1>
          {/* Prev code, code below was the original */}
          {/* <p style={fontFamily} className="text-lg text-muted-foreground leading-relaxed">
            Gracias por participar en las Elecciones 2026 de la Cooperativa Comarapa R.L.
          </p> */}
          <p style={fontFamily} className="text-primary font-semibold text-lg">
            Su voto ha sido registrado exitosamente.
          </p>
                    

          <p style={fontFamily} className="text-gray-400 font-semibold text-lg">
            Regresando a la pantalla principal...
          </p>
        {/* Prev code, code below was the original */}
        {/* <div className="flex items-center gap-2 text-sm text-muted-foreground">
          <div className="w-2 h-2 rounded-full bg-primary animate-pulse" ></div>
          <p style={{textAlign: "center"}} className="text-center">Regresando a la pantalla principal...</p>
        </div> */}
        </div>
